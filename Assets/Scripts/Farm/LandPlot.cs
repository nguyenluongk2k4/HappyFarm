...
public class LandPlot : MonoBehaviour
{
    ...
    public void Plant(CropData cropToPlant)
    {
        ...
        {
            // TODO: Trừ 1 HạtGiống (cropToPlant.seedItemName) khỏi Kho (UC-1.2)
            // (Hiện tại, chúng ta giả lập là luôn có hạt)
            Debug.Log("Đã gieo " + cropToPlant.seedItemName);
    ...
    public void Harvest()
    {
        ...
        {
            // TODO: Kiểm tra kho còn chỗ trống không (UC-1.3 Luồng phụ)
            // if (Inventory.IsFull()) { Debug.Log("Kho đã đầy!"); return; }

            // TODO: Thêm Nông sản vào Kho (UC-1.3)
            Debug.Log("Thu hoạch được " + currentCrop.harvestItemAmount + " " + currentCrop.harvestItemName);

            // TODO: Cộng XP (UC-1.3)
            Debug.Log("Nhận được " + currentCrop.xpGained + " XP");

            // TODO: Phát âm thanh "thu hoạch" (UC-1.3)
